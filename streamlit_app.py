...
# --- DATEN LADEN ---
# Wir laden die Spieler einmal am Anfang, damit sie überall verfügbar sind
try:
...
with tab1:
    ...
    if players:
        ...
        # Nur benötigte Spalten und Sortierung
...
with tab2:
    ...
    st.write("Gib die Match-ID ein (aus dem AutoDarts-Link).")
